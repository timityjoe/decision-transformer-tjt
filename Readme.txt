...
python3 run_dt_atari.py --seed 123 --block_size 90 --epochs 1 --model_type 'reward_conditioned' --num_steps 500 --num_buffers 50 --game 'Breakout' --batch_size 128  --log_level CRITICAL --data_dir_prefix ./dqn_replay
